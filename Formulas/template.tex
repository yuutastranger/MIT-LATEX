...
$$
$$
  F_1(\varepsilon\zeta) = \ch\varepsilon\zeta\cos\varepsilon\zeta, \quad
  F_2(\varepsilon\zeta) = [\ch\varepsilon\zeta\sin\varepsilon\zeta + \sh\varepsilon\zeta\cos\varepsilon\zeta]/2,
$$
$$
  \gamma(\omega) = \frac{1}{6}\frac{\varepsilon^3(\sh\varepsilon - \sin\varepsilon)}
  {\varepsilon^2(\ch\varepsilon + \cos\varepsilon) - 2\varepsilon(\sh\varepsilon + \sin\varepsilon) + 2(\ch\varepsilon - \cos\varepsilon)}.
$$
\end{document}
